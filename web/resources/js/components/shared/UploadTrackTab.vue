    ...
    <v-container>
      <v-row>
        <v-col cols="8">
          ...
          <v-file-input id="audio" label="Audio File" @change="onAudioFileChange" color="black"></v-file-input>
          <validation-errors-alert v-if="errors" :errors="errors.artwork"></validation-errors-alert>
          <v-file-input id="artwork" label="Artwork" @change="onArtworkFileChange" color="black"></v-file-input>
