<template>
  <content-layout>
    <template v-slot:title>Showing Results for "{{ $route.query.result }}"</template>
    <template v-slot:content>
      ...
      <div class="pt-4">
        <p
          v-if="noPicture && selectedChip === 'picture'"
        >Seems Like Your Search Did Not Match Any Pictures ...</p>
        <p
          v-if="noTrack && selectedChip === 'music'"
        >Seems Like Your Search Did Not Match Any Tracks ...</p>
      </div>
