  ...
  <v-container>
    <v-card flat class="mx-auto" width="400px">
      ...
      <v-form>
        ...
        <v-text-field v-model="registerFormData.name" label="Name" color="black"></v-text-field>
        <validation-errors-alert
          v-if="registerErrorMessages"
          :errors="registerErrorMessages.user_name"
        ></validation-errors-alert>
        <v-text-field v-model="registerFormData.user_name" label="User Id" prefix="@" color="black"></v-text-field>
        <validation-errors-alert v-if="registerErrorMessages" :errors="registerErrorMessages.email"></validation-errors-alert>
        <v-text-field v-model="registerFormData.email" label="Email" color="black"></v-text-field>
        <validation-errors-alert
          v-if="registerErrorMessages"
          :errors="registerErrorMessages.password"
        ></validation-errors-alert>
        <v-text-field
        ...
        ></v-text-field>
        <div class="my-4">
          <v-btn @click="register" outlined block :loading="loading">Submit</v-btn>
        </div>
      </v-form>
    </v-card>
  </v-container>
